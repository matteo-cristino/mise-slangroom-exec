...
# NOTE: You might want to remove this if slangroom-exec is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if slangroom-exec has other means of determining installable versions.
	list_github_tags
}
...
install_version() {
	...
	(
		...
		# TODO: Assert slangroom-exec executable exists.
		local tool_cmd
